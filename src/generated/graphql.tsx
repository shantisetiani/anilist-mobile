...
export type MediaListQuery = { __typename?: 'Query', MediaList?: { __typename?: 'MediaList', id: number, userId: number, mediaId: number, progress?: number | null, status?: MediaListStatus | null, score?: number | null, media?: { __typename?: 'Media', type?: MediaType | null, genres?: Array<string | null> | null, episodes?: number | null, title?: { __typename?: 'MediaTitle', userPreferred?: string | null } | null } | null } | null };
...
export const MediaDetailDocument = gql`
...
/**
 * __useMediaDetailQuery__
 *
 * To run a query within a React component, call `useMediaDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useMediaDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMediaDetailQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useMediaDetailQuery(baseOptions?: Apollo.QueryHookOptions<MediaDetailQuery, MediaDetailQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MediaDetailQuery, MediaDetailQueryVariables>(MediaDetailDocument, options);
      }
export function useMediaDetailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MediaDetailQuery, MediaDetailQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MediaDetailQuery, MediaDetailQueryVariables>(MediaDetailDocument, options);
        }
